...
import oneteampos.menu.action.DcBoxCheckAction;
import oneteampos.menu.action.MemberApplyAction;
import oneteampos.menu.action.MemberComboBoxAcion;
import oneteampos.menu.action.MemberSelectAction;
import oneteampos.menu.action.SvBoxCheckAction;
import oneteampos.menu.action.searchBtnAction;
...
public class MemberCheckDialog extends JDialog {
	...
	public MemberCheckDialog(MainFrame mainFrame) {
		...
		combo.addActionListener(new MemberComboBoxAcion(this));
		...
		table.addMouseListener(new MemberSelectAction(mainFrame, this));
		dcBox.addActionListener(new DcBoxCheckAction(mainFrame, this));
		svBox.addActionListener(new SvBoxCheckAction(mainFrame, this));
		...
		searchBtn.addMouseListener(new searchBtnAction(this));

		JPanel numPadPanel = new NumPad(searchField);
		...
		apply.addMouseListener(new MemberApplyAction(mainFrame, this));
