...
import oneteampos.menu.action.AddCartAction;
import oneteampos.menu.action.JDialogWindowAction;
import oneteampos.menu.allLayouts.Gbl;
import oneteampos.menu.component.MinusButton;
import oneteampos.menu.component.PlusButton;
import oneteampos.menu.component.SizeLabel;
import oneteampos.menu.component.sizeRadioButton;
...
//		this.menuCntList = new Vector<>();
		...
		addBtn.addActionListener(new AddCartAction(mainFrame, this));
	...
	private ArrayList<JPanel> getLinePanel() {
		...
		for(int i=0; i<line; ++i) {
			linePanels.add(new LinePanel((int)(MainFrame.FRAME_WIDTH*0.35)));
		}
		return linePanels;
	}
