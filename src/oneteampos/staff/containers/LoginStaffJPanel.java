...
import oneteampos.staff.actions.StaffLoginNumberkeyAction;

public class LoginStaffJPanel extends JPanel{
	...
	public LoginStaffJPanel(MainFrame mframe) {
		...
		mainframe.add(this);
		 ...
		 add(new BackBtn(mainframe , this, "LoginStaffPanel"));
		...
		for(int i = 0; i < keyboard.length; ++i) {
			keyboard[i].addMouseListener(new StaffLoginNumberkeyAction(mainframe ,this, inputLabel, keyboard[i], cntLabel, loginFailLabel));
